...
public class ExceptionTypes {
     ...
     * it has to be explicitly thrown in method signature.
     * Or has to be caught {}
     * When may this type of exception / method be used?
     * When no need to handle the exception (our end).
     * Is this meaningful? No. We want to handle exceptions
     * not only to propagate.
     *
     * @return
     * @throws IOException
     */
    ...
    /**
     * In this type of method / exception we take action

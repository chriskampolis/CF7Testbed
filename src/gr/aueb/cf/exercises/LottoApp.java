...
public class LottoApp {
    ...
    public static void main(String[] args) {
        try (Scanner in = new Scanner(new File("C:/temp/numbers.txt"));
             PrintStream ps = new PrintStream("C:/temp/resultlotto.txt", StandardCharsets.UTF_8)) {
...
//                return false; // Return false if a sequence of three or more consecutive numbers is found
//            }
//        }
//        return true; // Return true if no three consecutive numbers are found
//
